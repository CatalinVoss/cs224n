...
public class Sentence implements Serializable, Decodable {
  ...
  /**
   * Print this sentence nicely, highlighting both gold and guessed mentions
   * @param b The builder to append to
   * @param mentions The mentions that might occur in the sentence
   ...
   * @return The string builder passed as an argument with the sentence appended
   */
  public StringBuilder prettyPrint(StringBuilder b, List<Mention> mentions, Collection<Entity> gold, Collection<Entity> guess) {
    //--Relevant Mentions
    Map<Integer,Pair<Integer,Pair<Mention,Entity>>> mentionLocationsGold = new HashMap<Integer,Pair<Integer,Pair<Mention,Entity>>>();
    Map<Integer,Pair<Integer,Pair<Mention,Entity>>> mentionLocationsGuess = new HashMap<Integer,Pair<Integer,Pair<Mention,Entity>>>();
    for(Mention m : mentions){
      //(if it's relevant to this sentence)
      if(m.sentence == this){
        //(find corresponding entity)
