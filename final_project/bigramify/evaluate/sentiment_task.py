...
datapath = "../data/sentiment_data/"

parser = argparse.ArgumentParser();
parser.add_argument ("--verbose", type = bool, default = False);
parser.add_argument ("--trainMatrix", type = str, default = 'svr_bigrams_trainSentencesMatrix.npy')
parser.add_argument ("--trainLabels", type = str, default = '3classTrainLabels.npy')
parser.add_argument ("--testMatrix", type = str, default = 'svr_bigrams_devSentencesMatrix.npy')
