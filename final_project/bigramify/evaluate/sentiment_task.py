...
parser.add_argument ("--trainMatrix", type = str, default = 'tb_bigrams_trainSentencesMatrix.npy')
parser.add_argument ("--trainLabels", type = str, default = '3classTrainLabels.npy')
parser.add_argument ("--testMatrix", type = str, default = 'tb_bigrams_devSentencesMatrix.npy')
