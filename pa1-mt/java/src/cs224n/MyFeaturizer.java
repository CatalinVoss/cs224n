...
public class MyFeaturizer implements RuleFeaturizer<IString, String> {
  ...
  protected int countHits(String phrase, String[] arr) {
    ...
    return result+1; // Make sure we don't divide by zero by this sort of laplace smoothing
  }
  ...
  public List<FeatureValue<String>> ruleFeaturize(Featurizable<IString, String> f) {  
    ...
    // Combination of target and source phrase size
    ...
    //// Various previous experiments (see writeup for details)
    ////////////////////////////////////////////////////////////
